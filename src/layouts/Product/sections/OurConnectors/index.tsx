    ...
    <DefaultWrapper>
      <Wrapper>
        ...
        <ContainerContent>
          <div>
            <Title>
              USE <PrimaryTextColor>OUR</PrimaryTextColor> <SecondaryTextColor>CONNECTORS,</SecondaryTextColor>
            </Title>
            <Title>
              ADD <PrimaryTextColor>YOUR</PrimaryTextColor> <SecondaryTextColor>CONNECTORS.</SecondaryTextColor>
            </Title>
          </div>
          <ContainerTopics>
