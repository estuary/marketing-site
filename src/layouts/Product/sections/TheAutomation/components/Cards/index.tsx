        ...
        <Container>
            <ContainerCards>
                ...
                <Card
                    ...
                    description="Backfill unbounded historical data that seamlessly transitions to real-time streaming."
                >
                    <StaticImage
                        alt="icon-2"
            ...
            <ContainerCards>
                ...
                <Card
                    title="Cleaned Data"
                    description="Captured data is validated, de-duped, and stored in your bucket."
                    $reverse
                >
                    <StaticImage
                        alt="icon-5"
