  ...
  return (
    <Container>
      <Header>
        ...
        <Subtitle>
          Capture, transform, and materialize in real-time for an exact view of your data and every change that powers
      ...
      <Steps>
        <Step>
          ...
          <div>
            ...
            <StepDescription>Use 100s of no-code connectors for streaming CDC, real-time, or batch.</StepDescription>
          </div>
        </Step>
        ...
        <Step>
          ...
          <div>
            ...
            <StepDescription>Stream and store in your own storage, then replay any time.</StepDescription>
          </div>
        </Step>
      ...
      <FlowImageWrapper>
        ...
        <OracleLogoWrapper to="/source/oracle" aria-label="Oracle source" />
        <MySQLLogoWrapper to="/source/mysql" aria-label="MySQL source" />
        <PostgresLogoWrapper to="/source/postgres" aria-label="Postgres source" />
        <AmazonS3LogoWrapper to="/source/s" aria-label="Amazon S3 source" />
        <GoogleStorageLogoWrapper to="/source/gcs" aria-label="Google Storage source" />
        <AzureBlobStorageLogoWrapper to="/source/azure-blob-storage" aria-label="Azure source" />
        <NetsuiteLogoWrapper to="/source/netsuite-v" aria-label="Netsuite source" />
        <HubspotLogoWrapper to="/source/hubspot" aria-label="HubSpot source" />
        <SalesforceLogoWrapper to="/source/salesforce" aria-label="Salesforce source" />
        <HttpWebhookLogoWrapper to="/source/http-ingest" aria-label="Webhook source" />
        ...
        <OpenAiLogoWrapper to="/destination/pinecone" aria-label="Pinecone destination" />
        <DatabricksLogoWrapper to="/destination/databricks" aria-label="Databricks destination" />
      </FlowImageWrapper>
    </Container>
  );
};
