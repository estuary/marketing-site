    ...
    return (
        <Layout headerTheme="light">
            <LegalWrapper className="terms-root">
                ...
                <p>
                    By accessing or using our Website, or otherwise manifesting
                    your assent to these Terms of Use, you acknowledge that you
                ...
                <p>
                    ...
                    agreeing to their terms. For information on how Google helps
                    users share their data safely, see their information{' '}
                    <a href="https://support.google.com/accounts/answer/10130420?hl=en">
                        here
                    </a>
                    .
                </p>
                ...
                <p>
                    You may view all Content for your own personal,
                    non-commercial use, and no other use is permitted without
                    the prior written consent of Estuary. Estuary and its
                    licensors retain all right, title, and interest, including
                    all intellectual property rights, in and to the Content. You
                    must retain all copyright and other proprietary notices
                    contained in the original Content. You may not sell,
                    transfer, assign, license, sublicense, or modify the Content
                    or reproduce, display, publicly perform, make a derivative
                    version of, distribute, or otherwise use the Content in any
                    way for any public or commercial purpose. We reserve the
                    right to remove Content from our Website at any time for any
                    reason without any notice to you.
                </p>
                <p>
                    If you violate any part of this Agreement, your permission
                    to access the Content and the Website automatically
                ...
                <p>
                    ...
                    a link to or from any site is prohibited unless
                    establishment of such a link is approved in advance by us in
                    writing. All goodwill generated from the use of Estuary
                    Trademarks inures to our benefit.
                </p>
                <p>
                    Elements of the Website is protected by trade dress,
                    ...
                    framing or mirrors. None of the Content may be retransmitted
                ...
                <p>
                    Estuary’s community, like any community, functions best when
                ...
                <ul>
                    <li>
                        ...
                        the Website and will not use the Website for any
                        unlawful purpose;
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        gain access to any Content (as defined below), data,
                        files, or passwords related to the Website through
                    ...
                    <li>
                        ...
                        engines permission to use spiders to copy materials from
                        the public portions of the Website for the sole purpose
                        of, and solely to the extent necessary for, creating
                        publicly-available searchable indices of the materials,
                ...
                <p>
                    If you find something that violates our Community
                    Guidelines, please let us know, and we’ll review it.
                </p>
                ...
                <p>
                    Although we encourage you to e-mail us, we do not want you
                    to, and you should not, e-mail us any content that contains
                    confidential information. With respect to all e-mails and
                    communications you send to us, including, but not limited
                    to, feedback, questions, comments, suggestions, and the
                    like, we shall be free to use any ideas, concepts, know-how,
                    or techniques contained in your communications for any
                    purpose whatsoever, including but not limited to, the
                    development, production, and marketing of products and
                    services that incorporate such information without
                ...
                <p>
                    THE WEBSITE AND THE CONTENT ARE PROVIDED “AS IS” AND “AS
                    AVAILABLE” WITHOUT ANY WARRANTIES OF ANY KIND, INCLUDING
                    THAT THE WEBSITE OR CONTENT WILL OPERATE ERROR-FREE OR THAT
                    THE WEBSITE, ITS SERVERS, OR THE CONTENT ARE FREE OF
                ...
                <p>
                    ...
                    AND ANY WARRANTIES ARISING FROM A COURSE OF DEALING, COURSE
                    OF PERFORMANCE, OR USAGE OF TRADE.
                </p>
                <p>
                    THE WEBSITE MAY CONTAIN TECHNICAL INACCURACIES OR
                    TYPOGRAPHICAL ERRORS OR OMISSIONS. UNLESS REQUIRED BY
                    APPLICABLE LAWS, WE ARE NOT RESPONSIBLE FOR ANY SUCH
                    TYPOGRAPHICAL OR TECHNICAL ERRORS LISTED ON THE WEBSITE. WE
                    RESERVE THE RIGHT TO MAKE CHANGES, CORRECTIONS, AND/OR
                    IMPROVEMENTS TO THE WEBSITE AND/OR ADD OR REMOVE CONTENT AT
                    ANY TIME WITHOUT NOTICE.
                </p>
                <p>
                    IN CONNECTION WITH ANY WARRANTY, CONTRACT, OR COMMON LAW
                    TORT CLAIMS: (I) WE AND OUR LICENSORS SHALL NOT BE LIABLE
                    FOR ANY INCIDENTAL OR CONSEQUENTIAL DAMAGES, LOST PROFITS,
                    OR DAMAGES RESULTING FROM LOST DATA OR BUSINESS INTERRUPTION
                    RESULTING FROM THE USE OR INABILITY TO ACCESS AND USE THE
                    WEBSITE OR THE CONTENT, EVEN IF WE HAVE BEEN ADVISED OF THE
                    POSSIBILITY OF SUCH DAMAGES; AND (II) ANY DIRECT DAMAGES
                    THAT YOU MAY SUFFER AS A RESULT OF YOUR USE OF THE WEBSITE
                    OR THE CONTENT SHALL BE LIMITED TO FIFTY US DOLLARS ($50).
                </p>
                <p>
                ...
                <p>
                    ...
                    provided by others. You should contact the site
                    administrator or webmaster for those External Sites if you
                    have any concerns regarding such links or any content
                    located on such External Sites. We are not responsible for
                    ...
                    programs. If you decide to access linked External Sites, you
                ...
                <p>
                    ...
                    licensees, licensors, and assigns harmless from and against
                    any damages, liabilities, losses, expenses, claims, actions,
                    and/or demands, including, without limitation, reasonable
                    legal and accounting fees, arising or resulting from: (i)
                    your breach of this Agreement; (ii) your misuse of the
                    Content or the Website; and/or (iii) your violation of any
                    third-party rights, including without limitation any
                    copyright, trademark, property, publicity, or privacy right.
                    We shall provide notice to you of any such claim, suit, or
                    proceeding and shall assist you, at your expense, in
                    defending any such claim, suit, or proceeding. We reserve
                    the right to assume the exclusive defense and control (at
                    your expense) of any matter that is subject to
                ...
                <p>
                    ...
                    access the Website or the Content from outside of the United
                    States, you do so at your own risk. Whether inside or
                ...
                <p>
                    These Terms of Use are effective as of the last updated date
                    stated at the top. We may change these Terms of Use from
                    time to time with or without notice to you. Any such changes
                    will be posted on the Website. By accessing the Website
                    after we make any such changes to these Terms of Use, you
                    are deemed to have accepted such changes. Please refer back
                    to these Terms of Use on a regular basis.
                </p>
                ...
                <p>
                    ...
                    limited to the Dispute between us and you individually. To
                    the full extent permitted by law, (i) no arbitration or
                    proceeding shall be joined with any other; (ii) there is no
                    right or authority for any Dispute to be arbitrated or
                    resolved on a class action-basis or to utilize class action
                    procedures; and (iii) there is no right or authority for any
                    Dispute to be brought in a purported representative capacity
                    on behalf of the general public or any other persons. YOU
                    AGREE THAT YOU MAY BRING CLAIMS AGAINST US ONLY IN YOUR
                ...
                <p>
                    ...
                    waiving any other remedies under this Agreement, seek from
                    any court having jurisdiction any interim, equitable,
                    provisional, or injunctive relief that is necessary to
                    protect our rights and property pending the outcome of the
                    arbitration referenced above. All claims or disputes arising
                    out of or in connection with this Agreement shall be heard
                    exclusively by any of the federal or state courts of
                ...
                <p>
                    The Website is available only to individuals aged 13 years
                    or older. If you are 13 or older, but under the age of
                    majority in your jurisdiction, you should review the
                    Agreement with your parent or guardian to make sure that you
                    and your parent or guardian understand it. If you are under
                    the age of 13, you may use the Website only with the consent
                    of your parent or guardian. We reserve the right, in our
                    sole and absolute discretion, to deny you access to the
                    Website, or any portion of the Website, without notice and
                    without reason.
                </p>
                ...
                <p>
                    ...
                    and no such waiver shall be construed as a waiver in any
                    other or subsequent instance. Except as expressly agreed by
                    us and you in writing, this Agreement constitutes the entire
                    ...
                    with respect to the subject matter. The section headings are
