        ...
        <section className="podcast-hero">
          <div className="hero-container">
            <div className="hero-left">
              <div className="hero-heading">Tune into Real-Time</div>
              <div className="hero-subheading">
                Join us as we join other thought-leaders in the data engineering community as we discuss the current and
          ...
          <div className="episodes-wrap">
            ...
            <div className="episode-item">
              ...
              <div className="episode-right">
                <div className="episode-heading">Data Engineering Podcast</div>
            ...
            <div className="episode-item">
              ...
              <div className="episode-right">
                <div className="episode-heading">The Geek Narrator</div>
                <div className="episode-description">
                  Our VP Engineering Phil Fried joins Kaivalya Apte to get deep on the nuances of batch vs. streaming
        ...
        <section className="subscribe">
          <div className="subscribe-wrap">
            <div className="subscribe-left">
              <div className="subscribe-heading">Stay in the loop</div>
              <div className="subscribe-youtube">
                <span>Subscribe to our Youtube channel</span>
                <OutboundLink target="_blank" href="https://www.youtube.com/@estuarydev">
                  <SubscribeYoutubeButton />
                </OutboundLink>
              </div>
              <div className="subscribe-subheading">Subscribe to our newsletter to get the latest news and updates</div>
        ...
        <section className="signup">
          <div className="signup-bg">
            ...
            <div className="cta-wrap">
              ...
              <a href="https://estuary.dev/about/#contact-us">Contact us</a>
            </div>
          </div>
        </section>
      </div>
