  ...
  plugins: [
    ...
    `gatsby-plugin-less`,
    {
      ...
      options: {
        ...
        filter: (node) => Object.keys(rehypeSelectors).includes(node.internal.type),
        ...
        plugins: [
          ...
          },
          {
            ...
            pluginOptions: Object.assign(
              {},
              ...Object.entries(rehypeSelectors).map(([k, { pluginOpts }]) => ({ [k]: pluginOpts })),
            ),
          },
        ],
      },
